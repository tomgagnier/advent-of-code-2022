...
One Elf has the important job of loading all the rucksacks with supplies for the
...
The Elves have made a list of all the items currently in each rucksack (your
...
sticker on the badges. All the badges need to be pulled out of the rucksacks so
